...
class Tree_t {
    ...
    public:
        ...
        void rotate(Node_t<keyT, valT>* n, bool direction) {	// true - clockwise; false - counter clockwise
			if (!n) return;		
            if (n == root){		// n is root
            	if (direction == true) { // clockwise rotation and n has a left subtree
                ...
                else { // counter-clockwise rotation and n has a right subtree
